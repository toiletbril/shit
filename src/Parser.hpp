...
private:
   ...
   */
  [[nodiscard]] fn
  parse_command_list(std::initializer_list<Token::Kind> terminators) throws
      -> Expression *;
  ...
  [[nodiscard]] fn parse_function_definition(Token *name_token) throws
      -> Command *;

  [[nodiscard]] fn parse_expression(u8 min_precedence = 0) throws
      -> Expression *;
};
