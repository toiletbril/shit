 ...
 *
 * This file implements and is responsible for the bind builtin. The bind
 * builtin accepts readline key bindings without effect. The line editor is
 * the vendored toiletline, so key binding is not wired through this builtin.
 */
