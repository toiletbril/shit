 ...
 *
 * This file implements the newgrp builtin by resolving the system newgrp
 * program and replacing the shell process with it. The selected group remains
 * active for commands run by the replacement process.
 */
