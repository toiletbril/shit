...
(
    set -e
    test -f "${BASH_SOURCE[0]%/*}/goldens/errexit_source_inner.bash" &&
        . "${BASH_SOURCE[0]%/*}/goldens/errexit_source_inner.bash"
...
(
    set -e
    . "${BASH_SOURCE[0]%/*}/goldens/errexit_source_outer.bash"
...
(
    set -e
    test -f "${BASH_SOURCE[0]%/*}/goldens/errexit_source_failure.bash" &&
        . "${BASH_SOURCE[0]%/*}/goldens/errexit_source_failure.bash"
